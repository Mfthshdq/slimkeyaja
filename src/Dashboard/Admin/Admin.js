            ...
            <div style={{ display: 'flex', gap: '15px', marginBottom: '30px', justifyContent: 'center' }}>
                <button 
                    ...
                    style={{
                        padding: '10px 20px',
                        cursor: 'pointer',
                        backgroundColor: activeView === "admin" ? '#007bff' : '#e0e0e0',
                        color: activeView === "admin" ? 'white' : 'black',
                        border: 'none',
                        borderRadius: '5px',
                        fontWeight: 'bold'
                    }}
                ...
                <button 
                    ...
                    style={{
                        padding: '10px 20px',
                        cursor: 'pointer',
                        backgroundColor: activeView === "karyawan" ? '#007bff' : '#e0e0e0',
                        color: activeView === "karyawan" ? 'white' : 'black',
                        border: 'none',
                        borderRadius: '5px',
                        fontWeight: 'bold'
                    }}
